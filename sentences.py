...
"CHAPTER TWO THE FALLING STAR Then came the night of the first falling star.",
...
"'There's a man in it--men in it! Half roasted to death! Trying to escape!' At once, with a quick mental leap, he linked the Thing with the flash upon Mars.",
...
"CHAPTER THREE ON HORSELL COMMON I found a little crowd of perhaps twenty people surrounding the huge hole in which the cylinder lay.",
...
"The early editions of the evening papers had startled London with enormous headlines: 'A MESSAGE RECEIVED FROM MARS.",
...
"CHAPTER FOUR THE CYLINDER OPENS When I returned to the common the sun was setting.",
...
"As I drew nearer I heard Stent's voice: 'Keep back! Keep back!' A boy came running towards me.",
...
"We don't know what's in the confounded thing, you know!' I saw a young man, a shop assistant in Woking I believe he was, standing on the cylinder and trying to scramble out of the hole again.",
...
"CHAPTER FIVE THE HEAT-RAY After the glimpse I had had of the Martians emerging from the cylinder in which they had come to the earth from their planet, a kind of fascination paralysed my actions.",
...
"CHAPTER SIX THE HEAT-RAY IN THE CHOBHAM ROAD It is still a matter of wonder how the Martians are able to slay men so swiftly and so silently.",
...
"CHAPTER SEVEN HOW I REACHED HOME For my own part, I remember nothing of my flight except the stress of blundering against trees and stumbling through the heather.",
...
"And that behind me! It was frantic, fantastic! Such things, I told myself, could not be.",
...
"'What's it all abart?' 'Haven't you heard of the men from Mars?' said I; 'the creatures from Mars?' 'Quite enough,' said the woman over the gate.",
...
".",
".",
"But the horror of them!' 'Don't, dear!' said my wife, knitting her brows and putting her hand on mine.",
"'Poor Ogilvy!' I said.",
"'To think he may be lying dead there!' My wife at least did not find my experience incredible.",
...
"CHAPTER EIGHT FRIDAY NIGHT The most extraordinary thing to my mind, of all the strange and wonderful things that happened upon that Friday, was the dovetailing of the commonplace habits of our social order with the first beginnings of the series of events that was to topple that social order headlong.",
...
"CHAPTER NINE THE FIGHTING BEGINS Saturday lives in my memory as a day of suspense.",
...
"'They say,' said he, 'that there's another of those blessed things fallen there--number two.",
...
"'What's cover against this 'ere 'eat? Sticks to cook yer! What we got to do is to go as near as the ground'll let us, and then drive a trench.",
...
"CHAPTER TEN IN THE STORM Leatherhead is about twelve miles from Maybury Hill.",
...
"It was the third falling star! Close on its apparition, and blindingly violet by contrast, danced out the first lightning of the gathering storm, and the thunder burst like a rocket overhead.",
...
"And I was galloping hard to meet it! At the sight of the second monster my nerve went altogether.",
...
"CHAPTER ELEVEN AT THE WINDOW I have already said that my storms of emotion have a trick of exhausting themselves.",
...
"We'd been wiped out.",
"And the smell--good God! Like burnt meat! I was hurt across the back by the fall of the horse, and there I had to lie until I felt better.",
...
"CHAPTER TWELVE WHAT I SAW OF THE DESTRUCTION OF WEYBRIDGE AND SHEPPERTON As the dawn grew brighter we withdrew from the window from which we had watched the Martians, and went very quietly downstairs.",
...
"'What's brewing?' His voice and face were eager.",
...
"' 'What d'ye mean--a gun?' 'No, sir,' and the artilleryman began a vivid account of the Heat-Ray.",
...
"He's at Weybridge.",
"Know the way?' 'I do,' I said; and he turned his horse southward again.",
...
"' 'Death!' I shouted.",
"'Death is coming! Death!' and leaving him to digest that if he could, I hurried on after the artillery-man.",
...
"'Yonder! D'yer see them? Yonder!' Quickly, one after the other, one, two, three, four of the armoured Martians appeared, far away over the little trees, across the flat meadows that stretched towards Chertsey, and striding hurriedly towards the river.",
...
"To get under water! That was it! 'Get under water!' I shouted, unheeded.",
...
"'What do these things mean?' I stared at him and made no answer.",
...
"'And suddenly--fire, earthquake, death!' He relapsed into silence, with his chin now sunken almost to his knees.",
"Presently he began waving his hand.",
"'All the work--all the Sunday schools--What have we done--what has Weybridge done? Everything gone--everything destroyed.",
"The church! We rebuilt it only three years ago.",
"Gone! Swept out of existence! Why?' Another pause, and he broke out again like one demented.",
...
"'Are these creatures everywhere? Has the earth been given over to them?' 'Are we far from Sunbury?' 'Only this morning I officiated at early celebration----' 'Things have changed,' I said, quietly.",
"'You must keep your head.",
"There is still hope.",
"' 'Hope!' 'Yes.",
"Plentiful hope--for all this destruction!' I began to explain my view of our position.",
...
"'The end! The great and terrible day of the Lord! When men shall call upon the mountains and the rocks to fall upon them and hide them--hide them from the face of Him that sitteth upon the throne!' I began to understand the position.",
...
"' CHAPTER FOURTEEN IN LONDON My younger brother was in London when the Martians fell at Woking.",
...
"What the dickens does it all mean? The Martians can't get out of their pit, can they?' My brother could not tell him.",
...
"'Fighting at Weybridge! Full description! Repulse of the Martians! London in Danger!' He had to give threepence for a copy of that paper.",
...
"'A fire? What a devil of a row!' They both craned their heads out of the window, straining to hear what the policemen were shouting.",
...
"'Fire!' The bells of the neighbouring church made a jangling tumult, a cart carelessly driven smashed, amid shrieks and curses, against the water trough up the street.",
...
"George's Hill that we had heard at Upper Halliford.",
...
"Never once, after the Martian at St.",
...
"Elphinstone.",
"'What is this you are driving us into?' My brother stopped.",
...
"'Make way!' It was like riding into the smoke of a fire to approach the meeting point of the lane and road; the crowd roared like a fire, and the dust was hot and pungent.",
...
"'Way! Way!' One man's hands pressed on the back of another.",
...
"'Push on!' was the cry.",
"'Push on! They are coming!' In one cart stood a blind man in the uniform of the Salvation Army, gesticulating with his crooked fingers and bawling, 'Eternity! Eternity!' His voice was hoarse and very loud so that my brother could hear him long after he was lost to sight in the dust.",
...
"Pancras,' a huge timber waggon crowded with roughs.",
"A brewer's dray rumbled by with its two near wheels splashed with fresh blood.",
"'Clear the way!' cried the voices.",
"'Clear the way!' 'Eter-nity! Eter-nity!' came echoing down the road.",
...
"Through it all ran a refrain: 'Way! Way! The Martians are coming!' Few stopped and came aside from that flood.",
...
"'I can't go on! I can't go on!' My brother woke from his torpor of astonishment and lifted her up, speaking gently to her, and carried her to Miss Elphinstone.",
...
"'Where is there any water?' he said.",
...
"'They are coming! Go on!' Then my brother's attention was distracted by a bearded, eagle-faced man lugging a small handbag, which split even as my brother's eyes rested on it and disgorged a mass of sovereigns that seemed to break up into separate coins as it struck the ground.",
...
"'Make way!' So soon as the cab had passed, he flung himself, with both hands open, upon the heap of coins, and began thrusting handfuls in his pocket.",
...
"'Way! Way!' There was a smash as the pole of a carriage crashed into the cart that the man on horseback stopped.",
...
"CHAPTER SEVENTEEN THE 'THUNDER CHILD' Had the Martians aimed only at destruction, they might on Monday have annihilated the entire population of London, as it spread itself slowly through the home counties.",
...
"The _Thunder Child_ fired no gun, but simply drove full speed towards them.",
...
"You can't possibly move without making a noise, and I fancy _they_ are outside.",
...
"'The fifth cylinder,' I whispered, 'the fifth shot from Mars, has struck this house and buried us under the ruins!' For a time the curate was silent, and then he whispered: 'God have mercy upon us!' I heard him presently whimpering to himself.",
...
"CHAPTER TWO WHAT WE SAW FROM THE RUINED HOUSE After eating we crept back to the scullery, and there I must have dozed again, for when presently I looked round I was alone.",
...
"These bunches have since been named rather aptly, by that distinguished anatomist, Professor Howes, the _hands_.",
...
"A young Martian, there can now be no dispute, was really born upon earth during the war, and it was found attached to its parent, partially _budded_ off, just as young lilybulbs bud off, or like the young animals in the fresh-water polyp.",
...
"His prophecy, I remember, appeared in November or December, 1893, in a long-defunct publication, the _Pall Mall Budget_, and I recall a caricature of it in a pre-Martian periodical called _Punch_.",
...
"CHAPTER THREE THE DAYS OF IMPRISONMENT The arrival of a second fighting-machine drove us from our peephole into the scullery, for we feared that from his elevation the Martian might see down upon us behind our barrier.",
...
"And that was all.",
"CHAPTER FOUR THE DEATH OF THE CURATE It was on the sixth day of our imprisonment that I peeped for the last time, and presently found myself alone.",
...
".",
".",
"! The wine press of God!' Then he would suddenly revert to the matter of the food I withheld from him, praying, begging, weeping, at last threatening.",
...
"Woe unto this unfaithful city! Woe! Woe! Woe! Woe! Woe! To the inhabitants of the earth by reason of the other voices of the trumpet----' 'Shut up!' I said, rising to my feet, and in a terror lest the Martians should hear us.",
"'For God's sake----' 'Nay,' shouted the curate, at the top of his voice, standing likewise and extending his arms.",
"'Speak! The word of the Lord is upon me!' In three strides he was at the door leading into the kitchen.",
...
"An age of almost intolerable suspense intervened; then I heard it fumbling at the latch! It had found the door! The Martians understood doors! It worried at the catch for a minute, perhaps, and then the door opened.",
...
"CHAPTER FIVE THE STILLNESS My first act before I went into the pantry was to fasten the door between the kitchen and the scullery.",
...
"And oh! the sweetness of the air! CHAPTER SIX THE WORK OF FIFTEEN DAYS For some time I stood tottering on the mound regardless of my safety.",
...
"CHAPTER SEVEN THE MAN ON PUTNEY HILL I spent that night in the inn that stands at the top of Putney Hill, sleeping in a made bed for the first time since my flight to Leatherhead.",
...
"And you weren't killed at Weybridge?' I recognised him at the same moment.",
"'You are the artilleryman who came into my garden.",
"' 'Good luck!' he said.",
"'We are lucky ones! Fancy _you_!' He put out a hand, and I took it.",
...
"'Aren't you satisfied it _is_ up with humanity? I am.",
...
"We're under! We're beat!' I made him no answer.",
...
"'But what if there is? They'll get it right again.",
"And even if there's a delay, how can it alter the end? It's just men and ants.",
...
"Don't you see that?' 'Not begun!' I exclaimed.",
"'Not begun.",
...
"That game's up.",
"We're beat.",
"' 'But if that is so, what is there to live for?' The artilleryman looked at me for a moment.",
...
"' 'You mean----' 'I mean that men like me are going on living--for the sake of the breed.",
...
"Ugh! Fancy those brown creepers!' 'You don't mean to say----' 'I do.",
...
"'Great God!' cried I.",
"'But you are a man indeed!' And suddenly I gripped his hand.",
"'Eh!' he said, with his eyes shining.",
"'I've thought it out, eh?' 'Go on,' I said.",
...
"As if hell was built for rabbits! Well, the Martians will just be a godsend to these.",
...
"' 'No,' I cried, 'that's impossible! No human being----' 'What's the good of going on with such lies?' said the artilleryman.",
"'There's men who'd do it cheerful.",
"What nonsense to pretend there isn't!' And I succumbed to his conviction.",
...
"'What plans have you made?' He hesitated.",
"'Well, it's like this,' he said.",
"'What have we to do? We have to invent a sort of life where men can live and breed, and be sufficiently secure to bring the children up.",
"Yes--wait a bit, and I'll make it clearer what I think ought to be done.",
"The tame ones will go like all tame beasts; in a few generations they'll be big, beautiful, rich-blooded, stupid--rubbish! The risk is that we who keep wild will go savage--degenerate into a sort of big, savage rat.",
".",
".",
".",
...
"' 'As you meant me to go?' 'Well--I parleyed, didn't I?' 'We won't quarrel about that.",
"Go on.",
...
"And swish, bang, rattle, swish! Just as they are fumbling over it, _swish_ comes the Heat-Ray, and, behold! man has come back to his own.",
...
"'Why were you walking about the common,' I said, 'instead of being here?' 'Taking the air,' he said.",
"'I was coming back.",
"It's safer by night.",
"' 'But the work?' 'Oh, one can't always work,' he said, and in a flash I saw the man plain.",
...
"' Grotesque gleam of a time no history will ever fully describe! From that, in answer to my questions, he came round to his grandiose plans again.",
...
"Champagne! Great God! We've a heavy enough task before us! Let us take a rest and gather strength while we may.",
...
"CHAPTER EIGHT DEAD LONDON After I had parted from the artilleryman, I went down the hill, and by the High Street across the bridge to Fulham.",
...
"I turned down St.",
"John's Wood Road, and ran headlong from this unendurable stillness towards Kilburn.",
...
"CHAPTER NINE WRECKAGE And now comes the strangest thing in my story.",
...
"One man--the first--had gone to St.",
...
"I found myself in a house of kindly people, who had found me on the third day wandering, weeping, and raving through the streets of St.",
"John's Wood.",
...
"' I was startled.",
"Had I spoken my thought aloud? I turned, and the French window was open behind me.",
...
"CHAPTER TEN THE EPILOGUE I cannot but regret, now that I am concluding my story, how little I am able to contribute to the discussion of the many debatable questions which are still unsettled.",
